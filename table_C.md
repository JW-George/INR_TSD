...
**Table C.** Long-term forecasting results on time series benchmark datasets (ECL, Traffic, Weather, Ettm1, Ettm2, Etth1, and Etth2). We use prediction length O ∈ {96}. A lower MSE indicates better performance. Hereafter, for the tables, the best results are marked in bold, respectively with MSE/MAE. 
