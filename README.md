# Anonymous Repository for Paper Revision

We provide an anonymized repository containing the revision materials and response documents relevant to this submission (“2026ICML_INRTSD_review_response.pdf”).
We also attach the supplementary figures and tables separately; please see “figure\_{A,B,C,D}.md” and/or “table\_{A,B,C,D,E}.md”.
...
Figures A–D and Tables A–E present new results obtained during the review process and are attached, in order, at the end of this response letter for ease of reference. 
All experiments were conducted on a Linux server equipped with an NVIDIA A100-PCIE-40GB.
...
**Table E.** https://anonymous.4open.science/r/INR_TSD-FC7B/table_E.md
